...
// ---------------------------------- create paths and allocate memory ------------------------------------- //
    if	(j==0)	 										// MCMC
    {
        ...
        Path="G:/TravauxModels/EntomophagaMaimaiga/Input/WholeGM_CCModel/mcmc_results/";
        Prefix=mcmc_prefix;
        if		(i==1)
        {
            Name = "parms_";
        ...
        {
            printf("bad i value in filenames!!!\n");
            getc(stdin);
        }
    ...
    else if (j==1)	 									// Line Search MLE
    {
        ...
        if		(i==0)
        {
            Path="G:/TravauxModels/EntomophagaMaimaiga/Input/WholeGM_CCModel/max_lhood/";
            Name="max_lhood";
        }
        else if (i==4)
        {
    ...
    {
        Path="G:/TravauxModels/EntomophagaMaimaiga/Input/WholeGM_CCModel/profile_data/";
