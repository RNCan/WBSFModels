...
//else if (i==19)	{	low = -2.0;			high = -0.4;	}		//CK//
    ...
    {
        low = 150.0;			   //CK// stop2 R_end.  time when resting spores stop blooming
        high = 350.0;
    }
...
//else if (i==21)	{	low = 0.01;			high = 20.0;	}		//CK// Rain scaling parameter func 3 and 4
    ...
    {
        low = 0.50;			   //CK// Rain scaling parameter func 2
        high = 3.00;
    }
//else if (i==21)	{	low = 0.0000001;			high = 0.2;	}		//CK// temp scaling parameter
    ...
    {
        low = -2.50;			   //CK// RH scaling parameter
        high = -0.5;
    }

    else if (i==23)
    {
        low = -2.50;			   //CK// temp scaling parameter for muF
        high = -0.60;
    }
//else if (i==23)	{	low = 0.0001;			high = 0.2;	}		//CK// stop2 R_end.  time when resting spores stop blooming
    ...
    {
        low = 40.0;			   //CK// R_start.  time when resting spores start blooming
        high = 120.0;
    }
...
void load_fxd_parms(void *Paramstuff,int numb)
{
    ...
    int i=1;
    std::vector<double> parm_load(numb,0.0);
    FILE *ftp_parm_load;
