...
// ---------------------------------- create paths and allocate memory ------------------------------------- //
    if	(j==0)	 										// MCMC
    {
        ...
        Path="G:/TravauxModels/EntomophagaMaimaiga/Input/mcmc_results/";
        Prefix=mcmc_prefix;
        if		(i==1)
        {
            Name = "parms_";
    ...
    else if (j==1)	 									// Line Search MLE
    {
        ...
        if		(i==0)
        {
            Path="G:/TravauxModels/EntomophagaMaimaiga/Input/max_lhood/";
            Name="max_lhood";
        }
        else if (i==4)
        {
    ...
    {
        Path="G:/TravauxModels/EntomophagaMaimaiga/Input/profile_data/";
